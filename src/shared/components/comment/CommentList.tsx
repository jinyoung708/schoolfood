    ...
    <ul className="flex flex-col gap-[24px]">
      <li className="border-b border-gray-100 pb-[23px]">
        <CommentItem
          ...
          images={[
            '/schoolfood/schoolfood/images/img/product01.jpg',
            '/schoolfood/schoolfood/images/img/product02.jpg',
            '/schoolfood/schoolfood/images/img/product03.jpg',
            '/schoolfood/schoolfood/images/img/product04.jpg',
            '/schoolfood/schoolfood/images/img/product01.jpg',
            '/schoolfood/schoolfood/images/img/product02.jpg',
            '/schoolfood/schoolfood/images/img/product03.jpg',
            '/schoolfood/schoolfood/images/img/product04.jpg',
            '/schoolfood/schoolfood/images/img/product05.jpg',
            '/schoolfood/schoolfood/images/img/product05.jpg',
          ]}
        />
      </li>
