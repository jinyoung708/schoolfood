...
const categories = [
  {
    ...
    link: '/',
    subMenu: [
      { title: '3DEPTH A1', link: '/' },
      { title: '3DEPTH A2', link: '/' },
    ],
  },
  {
    title: '계육·수산가공',
    ...
    link: '/',
    subMenu: [
      { title: '3DEPTH B1', link: '/' },
      { title: '3DEPTH B2', link: '/' },
    ],
  },
  {
    title: '핫도그·만두·냉동기타',
    ...
    link: '/',
    subMenu: [{ title: '3DEPTH C1', link: '/' }],
  },
  {
    title: '계란·치즈·두부·묵',
    iconClass: styles.ico4,
    link: '/',
    subMenu: [{ title: '3DEPTH D1', link: '/' }],
  },
  {
    title: '음료류',
    iconClass: styles.ico5,
    link: '/',
    subMenu: [{ title: '3DEPTH E1', link: '/' }],
  },
  {
    title: '후식류',
    iconClass: styles.ico6,
    link: '/',
    subMenu: [{ title: '3DEPTH F1', link: '/' }],
  },
  {
    title: '소스·드레싱',
    iconClass: styles.ico7,
    link: '/',
    subMenu: [{ title: '3DEPTH G1', link: '/' }],
  },
  {
    title: '가공기타·비식품',
    iconClass: styles.ico8,
    link: '/',
    subMenu: [{ title: '3DEPTH H1', link: '/' }],
  },
  {
    title: '채식',
    iconClass: styles.ico9,
    link: '/',
    subMenu: [{ title: '3DEPTH I1', link: '/' }],
  },
  {
    title: '분가공·분류',
    iconClass: styles.ico10,
    link: '/',
    subMenu: [{ title: '3DEPTH J1', link: '/' }],
  },
  {
    title: '농산·수산·축산물',
    iconClass: styles.ico11,
    link: '/',
    subMenu: [{ title: '3DEPTH K1', link: '/' }],
  },
  {
    title: '자연드림',
    iconClass: styles.ico12,
    link: '/',
    subMenu: [{ title: '3DEPTH L1', link: '/' }],
  },
  {
    title: '중단상품',
    iconClass: styles.ico13,
    link: '/',
    subMenu: [{ title: '3DEPTH M1', link: '/' }],
  },
];
